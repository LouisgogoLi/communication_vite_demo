  ...
  <div class="slotpageclass">
    ...
    >
      <template #tableDefault>
        <el-table-column prop="simpleShow" label="" align="center" min-width="5%">
    ...
    <SlotTable class="slotElTable2" :propsTableData="tableData2">
      <template #tableDefault>
        <el-table-column prop="salaryItemName" label="薪資項目名稱"> </el-table-column>
    ...
    <SlotTable class="slotElTable3" :propsTableData="tableData3" :propsEmptyValue="sEmptyValue3">
      <template #tableDefault>
        <el-table-column prop="note" label="備註"> </el-table-column>
      </template>
    </SlotTable>
